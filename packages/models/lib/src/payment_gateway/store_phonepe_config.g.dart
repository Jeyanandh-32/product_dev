...
_StorePhonePeConfig _$StorePhonePeConfigFromJson(Map<String, dynamic> json) =>
    _StorePhonePeConfig(
      ...
      enableCards: json['enableCards'] as bool? ?? false,
      enableNetBanking: json['enableNetBanking'] as bool? ?? false,
      ...
      webhookAuthType:
          $enumDecodeNullable(
            _$WebhookAuthTypeEnumMap,
            json['webhookAuthType'],
          ) ??
...
Map<String, dynamic> _$StorePhonePeConfigToJson(_StorePhonePeConfig instance) =>
    <String, dynamic>{
      'id': instance.id,
