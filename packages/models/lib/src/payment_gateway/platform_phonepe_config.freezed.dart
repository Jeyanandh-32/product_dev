...
/// @nodoc
abstract mixin class $PlatformPhonePeConfigCopyWith<$Res>  {
  factory $PlatformPhonePeConfigCopyWith(PlatformPhonePeConfig value, $Res Function(PlatformPhonePeConfig) _then) = _$PlatformPhonePeConfigCopyWithImpl;
@useResult
$Res call({
 String id, bool isEnabled, PaymentGatewayEnv env, String? clientId, String? clientVersion, String? clientSecret, String? saltKey, int saltIndex, bool enableUpi, bool enableCards, bool enableNetBanking, bool enableEmi, bool enableWallets, String? allowedUpiApps, WebhookAuthType webhookAuthType, String? webhookSecretKey, DateTime createdAt, DateTime updatedAt
});
...
/// @nodoc
class _$PlatformPhonePeConfigCopyWithImpl<$Res>
    implements $PlatformPhonePeConfigCopyWith<$Res> {
  _$PlatformPhonePeConfigCopyWithImpl(this._self, this._then);

  final PlatformPhonePeConfig _self;
  final $Res Function(PlatformPhonePeConfig) _then;

/// Create a copy of PlatformPhonePeConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? isEnabled = null,Object? env = null,Object? clientId = freezed,Object? clientVersion = freezed,Object? clientSecret = freezed,Object? saltKey = freezed,Object? saltIndex = null,Object? enableUpi = null,Object? enableCards = null,Object? enableNetBanking = null,Object? enableEmi = null,Object? enableWallets = null,Object? allowedUpiApps = freezed,Object? webhookAuthType = null,Object? webhookSecretKey = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
...
/// Adds pattern-matching-related methods to [PlatformPhonePeConfig].
extension PlatformPhonePeConfigPatterns on PlatformPhonePeConfig {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PlatformPhonePeConfig value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PlatformPhonePeConfig() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PlatformPhonePeConfig value)  $default,){
final _that = this;
switch (_that) {
case _PlatformPhonePeConfig():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PlatformPhonePeConfig value)?  $default,){
final _that = this;
switch (_that) {
case _PlatformPhonePeConfig() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  bool isEnabled,  PaymentGatewayEnv env,  String? clientId,  String? clientVersion,  String? clientSecret,  String? saltKey,  int saltIndex,  bool enableUpi,  bool enableCards,  bool enableNetBanking,  bool enableEmi,  bool enableWallets,  String? allowedUpiApps,  WebhookAuthType webhookAuthType,  String? webhookSecretKey,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlatformPhonePeConfig() when $default != null:
return $default(_that.id,_that.isEnabled,_that.env,_that.clientId,_that.clientVersion,_that.clientSecret,_that.saltKey,_that.saltIndex,_that.enableUpi,_that.enableCards,_that.enableNetBanking,_that.enableEmi,_that.enableWallets,_that.allowedUpiApps,_that.webhookAuthType,_that.webhookSecretKey,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  bool isEnabled,  PaymentGatewayEnv env,  String? clientId,  String? clientVersion,  String? clientSecret,  String? saltKey,  int saltIndex,  bool enableUpi,  bool enableCards,  bool enableNetBanking,  bool enableEmi,  bool enableWallets,  String? allowedUpiApps,  WebhookAuthType webhookAuthType,  String? webhookSecretKey,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _PlatformPhonePeConfig():
return $default(_that.id,_that.isEnabled,_that.env,_that.clientId,_that.clientVersion,_that.clientSecret,_that.saltKey,_that.saltIndex,_that.enableUpi,_that.enableCards,_that.enableNetBanking,_that.enableEmi,_that.enableWallets,_that.allowedUpiApps,_that.webhookAuthType,_that.webhookSecretKey,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  bool isEnabled,  PaymentGatewayEnv env,  String? clientId,  String? clientVersion,  String? clientSecret,  String? saltKey,  int saltIndex,  bool enableUpi,  bool enableCards,  bool enableNetBanking,  bool enableEmi,  bool enableWallets,  String? allowedUpiApps,  WebhookAuthType webhookAuthType,  String? webhookSecretKey,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _PlatformPhonePeConfig() when $default != null:
return $default(_that.id,_that.isEnabled,_that.env,_that.clientId,_that.clientVersion,_that.clientSecret,_that.saltKey,_that.saltIndex,_that.enableUpi,_that.enableCards,_that.enableNetBanking,_that.enableEmi,_that.enableWallets,_that.allowedUpiApps,_that.webhookAuthType,_that.webhookSecretKey,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _PlatformPhonePeConfig implements PlatformPhonePeConfig {
  const _PlatformPhonePeConfig({required this.id, this.isEnabled = true, this.env = PaymentGatewayEnv.uat, this.clientId, this.clientVersion, this.clientSecret, this.saltKey, this.saltIndex = 1, this.enableUpi = true, this.enableCards = true, this.enableNetBanking = true, this.enableEmi = false, this.enableWallets = false, this.allowedUpiApps, this.webhookAuthType = WebhookAuthType.hmac, this.webhookSecretKey, required this.createdAt, required this.updatedAt});
  factory _PlatformPhonePeConfig.fromJson(Map<String, dynamic> json) => _$PlatformPhonePeConfigFromJson(json);
...
@pragma('vm:prefer-inline')
_$PlatformPhonePeConfigCopyWith<_PlatformPhonePeConfig> get copyWith => __$PlatformPhonePeConfigCopyWithImpl<_PlatformPhonePeConfig>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PlatformPhonePeConfigToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlatformPhonePeConfig&&(identical(other.id, id) || other.id == id)&&(identical(other.isEnabled, isEnabled) || other.isEnabled == isEnabled)&&(identical(other.env, env) || other.env == env)&&(identical(other.clientId, clientId) || other.clientId == clientId)&&(identical(other.clientVersion, clientVersion) || other.clientVersion == clientVersion)&&(identical(other.clientSecret, clientSecret) || other.clientSecret == clientSecret)&&(identical(other.saltKey, saltKey) || other.saltKey == saltKey)&&(identical(other.saltIndex, saltIndex) || other.saltIndex == saltIndex)&&(identical(other.enableUpi, enableUpi) || other.enableUpi == enableUpi)&&(identical(other.enableCards, enableCards) || other.enableCards == enableCards)&&(identical(other.enableNetBanking, enableNetBanking) || other.enableNetBanking == enableNetBanking)&&(identical(other.enableEmi, enableEmi) || other.enableEmi == enableEmi)&&(identical(other.enableWallets, enableWallets) || other.enableWallets == enableWallets)&&(identical(other.allowedUpiApps, allowedUpiApps) || other.allowedUpiApps == allowedUpiApps)&&(identical(other.webhookAuthType, webhookAuthType) || other.webhookAuthType == webhookAuthType)&&(identical(other.webhookSecretKey, webhookSecretKey) || other.webhookSecretKey == webhookSecretKey)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}
...
/// @nodoc
abstract mixin class _$PlatformPhonePeConfigCopyWith<$Res> implements $PlatformPhonePeConfigCopyWith<$Res> {
  factory _$PlatformPhonePeConfigCopyWith(_PlatformPhonePeConfig value, $Res Function(_PlatformPhonePeConfig) _then) = __$PlatformPhonePeConfigCopyWithImpl;
@override @useResult
$Res call({
 String id, bool isEnabled, PaymentGatewayEnv env, String? clientId, String? clientVersion, String? clientSecret, String? saltKey, int saltIndex, bool enableUpi, bool enableCards, bool enableNetBanking, bool enableEmi, bool enableWallets, String? allowedUpiApps, WebhookAuthType webhookAuthType, String? webhookSecretKey, DateTime createdAt, DateTime updatedAt
});
...
/// @nodoc
class __$PlatformPhonePeConfigCopyWithImpl<$Res>
    implements _$PlatformPhonePeConfigCopyWith<$Res> {
  __$PlatformPhonePeConfigCopyWithImpl(this._self, this._then);

  final _PlatformPhonePeConfig _self;
  final $Res Function(_PlatformPhonePeConfig) _then;

/// Create a copy of PlatformPhonePeConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? isEnabled = null,Object? env = null,Object? clientId = freezed,Object? clientVersion = freezed,Object? clientSecret = freezed,Object? saltKey = freezed,Object? saltIndex = null,Object? enableUpi = null,Object? enableCards = null,Object? enableNetBanking = null,Object? enableEmi = null,Object? enableWallets = null,Object? allowedUpiApps = freezed,Object? webhookAuthType = null,Object? webhookSecretKey = freezed,Object? createdAt = null,Object? updatedAt = null,}) {
  return _then(_PlatformPhonePeConfig(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,isEnabled: null == isEnabled ? _self.isEnabled : isEnabled // ignore: cast_nullable_to_non_nullable
as bool,env: null == env ? _self.env : env // ignore: cast_nullable_to_non_nullable
as PaymentGatewayEnv,clientId: freezed == clientId ? _self.clientId : clientId // ignore: cast_nullable_to_non_nullable
