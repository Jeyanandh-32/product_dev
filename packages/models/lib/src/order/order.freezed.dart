...
mixin _$Order {
 ...
 String get id; String get merchantId; String get storeId; String get orderReference; int get billNo; OrderSource get source; OrderType get type; OrderStatus get status;@JsonKey(unknownEnumValue: PaymentStatus.pending) PaymentStatus get paymentStatus; PaymentMethod get paymentMethod; double get subtotal; double get discountTotal; double get walletDeduction; double get taxTotal; double get platformFee; double get gatewayCharges; double get grandTotal; String? get terminalCode; Customer? get customer; List<OrderItem> get items; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,merchantId,storeId,orderReference,billNo,source,type,status,paymentStatus,paymentMethod,subtotal,discountTotal,walletDeduction,taxTotal,platformFee,gatewayCharges,grandTotal,terminalCode,customer,const DeepCollectionEquality().hash(items),createdAt,updatedAt]);

@override
String toString() {
  return 'Order(id: $id, merchantId: $merchantId, storeId: $storeId, orderReference: $orderReference, billNo: $billNo, source: $source, type: $type, status: $status, paymentStatus: $paymentStatus, paymentMethod: $paymentMethod, subtotal: $subtotal, discountTotal: $discountTotal, walletDeduction: $walletDeduction, taxTotal: $taxTotal, platformFee: $platformFee, gatewayCharges: $gatewayCharges, grandTotal: $grandTotal, terminalCode: $terminalCode, customer: $customer, items: $items, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
class _Order implements Order {
  const _Order({required this.id, required this.merchantId, required this.storeId, required this.orderReference, required this.billNo, required this.source, required this.type, required this.status, @JsonKey(unknownEnumValue: PaymentStatus.pending) required this.paymentStatus, required this.paymentMethod, required this.subtotal, this.discountTotal = 0.0, this.walletDeduction = 0.0, required this.taxTotal, this.platformFee = 0.0, this.gatewayCharges = 0.0, required this.grandTotal, this.terminalCode, this.customer, required this.items, required this.createdAt, required this.updatedAt});
