...
@override
String toString() {
  return 'Counter(id: $id, name: $name, merchantId: $merchantId, storeId: $storeId, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
class _Counter implements Counter {
  const _Counter({required this.id, required this.name, required this.merchantId, required this.storeId, required this.isActive, required this.createdAt, required this.updatedAt});
