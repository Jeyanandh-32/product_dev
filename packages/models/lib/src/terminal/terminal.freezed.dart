...
mixin _$Terminal {
 ...
 String get code; String get merchantId; String get storeId; String get name; bool get isActive; DateTime get createdAt; DateTime get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,merchantId,storeId,name,isActive,createdAt,updatedAt);

@override
String toString() {
  return 'Terminal(code: $code, merchantId: $merchantId, storeId: $storeId, name: $name, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String code, String merchantId, String storeId, String name, bool isActive, DateTime createdAt, DateTime updatedAt
});
...
/// Create a copy of Terminal
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? code = null,Object? merchantId = null,Object? storeId = null,Object? name = null,Object? isActive = null,Object? createdAt = null,Object? updatedAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String code,  String merchantId,  String storeId,  String name,  bool isActive,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Terminal() when $default != null:
return $default(_that.code,_that.merchantId,_that.storeId,_that.name,_that.isActive,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String code,  String merchantId,  String storeId,  String name,  bool isActive,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Terminal():
return $default(_that.code,_that.merchantId,_that.storeId,_that.name,_that.isActive,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String code,  String merchantId,  String storeId,  String name,  bool isActive,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Terminal() when $default != null:
return $default(_that.code,_that.merchantId,_that.storeId,_that.name,_that.isActive,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Terminal implements Terminal {
  const _Terminal({required this.code, required this.merchantId, required this.storeId, required this.name, required this.isActive, required this.createdAt, required this.updatedAt});
...
/// Create a copy of Terminal
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? code = null,Object? merchantId = null,Object? storeId = null,Object? name = null,Object? isActive = null,Object? createdAt = null,Object? updatedAt = null,}) {
