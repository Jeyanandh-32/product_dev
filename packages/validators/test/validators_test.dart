...
void main() {
  group('TerminalValidator.create', () {
    test('returns error when name is empty', () {
      expect(
        TerminalValidator.create(name: '', password: 'Password1'),
        'Terminal Name is required.',
      );
      expect(
        TerminalValidator.create(name: null, password: 'Password1'),
        'Terminal Name is required.',
      );
    });
    ...
    test('returns error when password is empty', () {
      expect(
        TerminalValidator.create(name: 'Terminal 1', password: ''),
        'Password is required.',
      );
      expect(
        TerminalValidator.create(name: 'Terminal 1', password: null),
        'Password is required.',
      );
    });
    ...
    test('returns null when valid input is provided', () {
      expect(
        TerminalValidator.create(name: 'Terminal 1', password: 'Password1'),
        isNull,
      );
    });
  });
  ...
  group('TerminalValidator.update', () {
    ...
    test('returns error when password is empty', () {
      expect(
        TerminalValidator.update(password: ''),
