...
class OrderRepository {
  ...
  > getPaymentSummary({
    ...
    DateTime? fromDate,
    DateTime? toDate,
  }) => _reportsRepo.getPaymentSummary(
    merchantId: merchantId,
    storeId: storeId,
    fromDate: fromDate,
    toDate: toDate,
  ...
  /// Computes aggregated live dashboard metrics for charts and summaries.
  Future<Map<String, dynamic>> getDashboardAnalytics({
    required String merchantId,
    required String storeId,
    DateTime? fromDate,
    DateTime? toDate,
  }) => _reportsRepo.getDashboardAnalytics(
    merchantId: merchantId,
    storeId: storeId,
    fromDate: fromDate,
    toDate: toDate,
