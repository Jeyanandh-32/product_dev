...
@override
String toString() {
  return 'ProductDto(id: $id, merchantId: $merchantId, name: $name, taxRate: $taxRate, basePrice: $basePrice, sellingPrice: $sellingPrice, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt, categoryId: $categoryId, counterId: $counterId, sku: $sku, barcode: $barcode, description: $description, imageUrl: $imageUrl, stock: $stock)';
}
