...
class InventoryCountersPaginationToolbar extends StatefulWidget {
  ...
  @override
  State<InventoryCountersPaginationToolbar> createState() =>
      _InventoryCountersPaginationToolbarState();
}

class _InventoryCountersPaginationToolbarState
    extends State<InventoryCountersPaginationToolbar>
              ...
              Row(
                ...
                children: [
                  _buildNavButton(
                    ...
                    page > 1,
                    () => counterPageSignal.value = page - 1,
                  ),
                  Padding(
