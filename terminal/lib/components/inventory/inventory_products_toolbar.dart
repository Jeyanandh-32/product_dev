...
import 'package:terminal/components/inventory/products/inventory_bottle_return_button.dart';
...
export 'package:terminal/components/inventory/products/inventory_bottle_return_button.dart';
          ...
          builder: (context) {
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Gap(8),
                      if (isBottleEnabled) ...[
                        InventoryBottleReturnButton(isCompact: collapseButtons),
                        const Gap(8),
                      ],
            ...
            return Row(
              children: [
                ...
                if (isBottleEnabled) ...[
                  const Gap(8),
                  const InventoryBottleReturnButton(),
                ],
                const Gap(8),
                _buildAddButton(),
              ],
