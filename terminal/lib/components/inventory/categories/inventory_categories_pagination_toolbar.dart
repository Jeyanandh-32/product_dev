...
class InventoryCategoriesPaginationToolbar extends StatefulWidget {
  ...
  @override
  State<InventoryCategoriesPaginationToolbar> createState() =>
      _InventoryCategoriesPaginationToolbarState();
}

class _InventoryCategoriesPaginationToolbarState
    extends State<InventoryCategoriesPaginationToolbar>
              ...
              Row(
                ...
                children: [
                  _buildNavButton(
                    ...
                    page > 1,
                    () => categoryPageSignal.value = page - 1,
                  ),
                  Padding(
    ...
    return MouseRegion(
      ...
      child: PressableBox(
        ...
        style: BoxStyler()
            ...
            .onHovered(
              enabled
                  ? BoxStyler().color(const Color(0xFFE2E8F0))
                  : BoxStyler(),
            ),
        child: Icon(
          icon,
