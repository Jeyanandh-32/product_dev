...
class InventoryCategoriesPaginationToolbar extends StatefulWidget {
  const InventoryCategoriesPaginationToolbar({super.key});

  @override
  State<InventoryCategoriesPaginationToolbar> createState() => _InventoryCategoriesPaginationToolbarState();
}

class _InventoryCategoriesPaginationToolbarState extends State<InventoryCategoriesPaginationToolbar> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return SignalBuilder(builder: (context) {
      ...
      final totalPages = categoryTotalPagesSignal.value;
      ...
      return Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            Row(mainAxisSize: MainAxisSize.min, children: [
              _buildNavButton(FLucideIcons.chevronLeft, page > 1, () => categoryPageSignal.value = page - 1),
              ...
              _buildNavButton(FLucideIcons.chevronRight, page < totalPages, () => categoryPageSignal.value = page + 1),
            ]),
          ],
        ),
      );
          ...
          child: Column(
            ...
            children: [10, 25, 50, 100].map((size) {
              ...
              return MouseRegion(
                ...
                child: PressableBox(
                  onPress: () {
                    categoryEntriesSignal.value = size;
