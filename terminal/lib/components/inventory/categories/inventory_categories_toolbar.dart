...
class InventoryCategoriesToolbar extends StatefulWidget {
  ...
  @override
  State<InventoryCategoriesToolbar> createState() => _InventoryCategoriesToolbarState();
}

class _InventoryCategoriesToolbarState extends State<InventoryCategoriesToolbar> {
    ...
    return SignalBuilder(builder: (context) {
      ...
      if (isMobile) {
        return Column(
          ...
          children: [
            Row(children: [Expanded(child: _buildSearchBox()), const Gap(8), _buildAddButton()]),
            const Gap(10),
        ...
        child: PressableBox(
          ...
          child: const Row(
            ...
            children: [
              ...
              Gap(6),
              Text('Add Category', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: Color(0xFFFFFFFF))),
            ],
          ),
        ),
      );
