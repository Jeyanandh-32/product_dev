...
class OrderStatusCard extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    ...
    return div(
      classes:
          'bg-white rounded-3xl p-6 sm:p-8 border border-gray-200/80 shadow-sm flex flex-col items-center text-center gap-5 w-full',
      [
        ...
        h1(
          classes: 'text-3xl font-black text-black tracking-tight',
          [.text(titleText)],
        ),
        p(
          classes:
              'text-sm text-gray-500 font-medium flex flex-col items-center gap-0.5',
          [
            span(
              classes: 'font-extrabold text-black text-base',
        ...
        div(classes: 'w-full flex flex-col gap-2 text-sm', [
          ...
          div(
            classes:
                'flex justify-between text-base font-extrabold text-black pt-2 border-t border-gray-100',
            [
